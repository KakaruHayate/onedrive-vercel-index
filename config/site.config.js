...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'recoder@kakaru.live',
  ...
  email: 'mailto:recoder@kakaru.live',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/kakaruhayate/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/kakaruhayate',
    },
  ],
